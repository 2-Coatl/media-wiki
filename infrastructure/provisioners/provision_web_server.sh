...
install_base_system() {
    ...
    bash "$PROJECT_ROOT/infrastructure/installation/install_base.sh"
}
...
install_apache() {
    ...
    bash "$PROJECT_ROOT/infrastructure/installation/install_apache.sh"
}

install_php() {
    log_step "[5/8] Installing PHP"
    bash "$PROJECT_ROOT/infrastructure/installation/install_php.sh"
}

install_mediawiki() {
    log_step "[6/8] Installing MediaWiki"
    bash "$PROJECT_ROOT/infrastructure/installation/install_mediawiki.sh"
}
...
show_completion_message() {
    ...
    echo "  sudo bash /vagrant/infrastructure/migration/migrate_to_mariadb.sh"
    echo ""
    echo "========================================"
    echo ""
}
