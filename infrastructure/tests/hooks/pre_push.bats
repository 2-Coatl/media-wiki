...
setup() {
  export SCRIPT="${BATS_TEST_DIRNAME}/../../../infrastructure/git_hooks/pre_push"
...
@test "pre_push ejecuta validaciones con cobertura suficiente" {
...
@test "pre_push falla cuando la cobertura es insuficiente" {
