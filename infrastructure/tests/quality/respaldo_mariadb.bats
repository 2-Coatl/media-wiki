...
STUB
  ...
  secrets_file="$REPO_ROOT/infrastructure/config/secrets.env"
...
@test "create_mariadb_backup: genera un respaldo comprimido" {
...
@test "create_mariadb_backup: purga respaldos fuera de retencion" {
